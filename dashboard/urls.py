...
from .management import ManualUserRegistrationView, ManualEnrollmentView, ManualCertificateView, BroadcastEmailView, EnrollmentManagementView, BroadcastHistoryView
...
urlpatterns = [
    ...
    path('management/broadcast-history/', BroadcastHistoryView.as_view(), name='dashboard-broadcast-history'),
]
